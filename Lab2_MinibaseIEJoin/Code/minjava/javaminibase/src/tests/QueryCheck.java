...
public class QueryCheck {
  ...
  public QueryCheck(int q_index) {
    ...
    Q1result.addElement (new S1("Mike Carey", "05/11/95"));
    Q1result.addElement (new S1("Yannis Ioannidis", "05/10/95"));
    ...
    case 1:
      ...
      tuplenum = 2;                     // the total number of answer.
      grouporder = new Order(Order.SORT);
      mygroup[0].len = 2;              // each group length.
